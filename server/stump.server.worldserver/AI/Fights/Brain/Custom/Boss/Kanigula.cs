...
{
    [BrainIdentifier(3556)]
    public class Kanigula : Brain
    {
        public Kanigula(AIFighter fighter)
            : base(fighter)
        {
        ...
        private void Fight_FightStarted(IFight obj)
        {
            ...
            Fighter.CastAutoSpell(new Spell((int)SpellIdEnum.ANIMAL_PHEROMONES, 1), Fighter.Cell);
        }
        ...
        public override void Play()
        {
            foreach (var spell in Fighter.Spells.Values)
            {
                ...
                if(spell.Id == 4091)
                {
                   Fighter.CastSpell(new Spell(4091, 1), Fighter.Cell);
                }
                if (spell.Id == 4092)
                {
                    Fighter.CastSpell(new Spell(4092, 1), Fighter.Cell);
                }
