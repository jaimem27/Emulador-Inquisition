...
{
    [BrainIdentifier(230)]
    public class LeChuco : Brain
    {
        public LeChuco(AIFighter fighter)
            : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell((int)SpellIdEnum.PIRATE_CURSE_6103, 1), Fighter.Cell);
        }
        ...
        public override void Play()
        {
            ...
            foreach (var spell in Fighter.Spells.Values)
            {
                if (spell.Id == 6104)
                {
                    Fighter.CastSpell(new Spell(6104, 1), Fighter.Cell);
