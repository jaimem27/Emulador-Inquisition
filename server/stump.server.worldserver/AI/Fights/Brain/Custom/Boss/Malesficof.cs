...
{
    [BrainIdentifier(3652)]
    public class Malesticof : Brain
    {
        public Malesticof(AIFighter fighter)
            : base(fighter)
        {
        ...
        private void Fight_FightStarted(IFight obj)
        {
            ...
            Fighter.CastAutoSpell(new Spell(4505, 1), Fighter.Cell);
        }
        ...
        public override void Play()
        {
            ...
            foreach (var spell in Fighter.Spells.Values)
            {
                ...
                if (Fighter.AP > 3)
                {
                    Fighter.CastSpell(new Spell(4508, 1), Fighter.Cell);
                }
                ...
                if (spell.Id == 4507)
                {
                    Fighter.CastSpell(new Spell(4507, 1), target.Cell);
                    
                }

                if (spell.Id == 4506)
                {
                    Fighter.CastSpell(new Spell(4506, 1), target.Cell);
                }
