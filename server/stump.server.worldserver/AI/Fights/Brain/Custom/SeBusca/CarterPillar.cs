...
{
    [BrainIdentifier(5084)]
    public class CarterPillar : Brain
    {
        public CarterPillar(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(9009, 1), Fighter.Cell);
    ...
    [BrainIdentifier(5085)]
    public class CarterPillarInvo : Brain
    {
        public CarterPillarInvo(AIFighter fighter)
           : base(fighter)
        {
        ...
        private void OnTurnStarted(IFight obj, FightActor actor)
        {
            if (Fighter.IsSummoned())
                Fighter.CastAutoSpell(new Spell(9029, 1), Fighter.Cell);
            //Fighter.CastAutoSpell(new Spell(12105, 1), Fighter.Cell);
        }
