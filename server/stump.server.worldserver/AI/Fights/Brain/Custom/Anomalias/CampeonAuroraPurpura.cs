...
{
    [BrainIdentifier(5662)]
    public class CampeonAuroraPurpura : Brain
    {
        public CampeonAuroraPurpura(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(12357,1), Fighter.Cell);
            Fighter.CastAutoSpell(new Spell(11957,1), Fighter.Cell);
        }
