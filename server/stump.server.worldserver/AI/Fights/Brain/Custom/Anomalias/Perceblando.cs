...
{
    [BrainIdentifier(5687)]
    public class Perceblando : Brain
    {
        public Perceblando(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(12362, 1), Fighter.Cell);
            Fighter.CastAutoSpell(new Spell(12118, 1), Fighter.Cell);
        }
