...
{
    [BrainIdentifier(5682)]
    public class CuervoNegro : Brain
    {
        public CuervoNegro(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(12374, 1), Fighter.Cell);
            Fighter.CastAutoSpell(new Spell(12059, 1), Fighter.Cell);
        }
