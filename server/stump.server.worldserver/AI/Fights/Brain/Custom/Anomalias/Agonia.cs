...
{
    [BrainIdentifier(5684)]
    public class Agonia : Brain
    {
        public Agonia(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            //Fighter.CastAutoSpell(new Spell(12375, 1), Fighter.Cell);
    ...
    [BrainIdentifier(5685)]
    public class AgoniaInvo : Brain
    {
        public AgoniaInvo(AIFighter fighter)
            : base(fighter)
        {
        ...
        {
            if (Fighter == actor)
                Fighter.CastAutoSpell(new Spell(12106, 1), Fighter.Cell);

        }
    }

    [BrainIdentifier(5686)]
    public class AgoniaInvo2 : Brain
    {
        public AgoniaInvo2(AIFighter fighter)
            : base(fighter)
        {
            fighter.Fight.TurnStarted += OnTurnStarted;
        }
        ...
        {
            if (Fighter == actor)
                Fighter.CastAutoSpell(new Spell(12137, 1), Fighter.Cell);
