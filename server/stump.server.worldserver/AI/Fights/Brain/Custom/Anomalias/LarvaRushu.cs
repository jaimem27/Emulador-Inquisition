...
{
    [BrainIdentifier(5683)]
    public class LarcaRushu : Brain
    {
        public LarcaRushu(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(12376, 1), Fighter.Cell);
            //Fighter.CastAutoSpell(new Spell(12073, 1), Fighter.Cell);
        }
