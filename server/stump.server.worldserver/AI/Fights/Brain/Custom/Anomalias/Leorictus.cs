...
{
    [BrainIdentifier(5688)]
    public class Leorictus : Brain
    {
        public Leorictus(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(12359, 1), Fighter.Cell);
            Fighter.CastAutoSpell(new Spell(12360, 1), Fighter.Cell);
            //Fighter.CastAutoSpell(new Spell(12162, 1), Fighter.Cell);
        }
