...
{
    [BrainIdentifier(5755)]
    public class Sucubo : Brain
    {
        public Sucubo(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(12355, 1), Fighter.Cell);
           //Fighter.CastAutoSpell(new Spell(12387, 1), Fighter.Cell);
        }
    ...
    [BrainIdentifier(5763)]
    public class SucuboInvo : Brain
    {
        public SucuboInvo(AIFighter fighter)
            : base(fighter)
        {
        ...
        {
            if (Fighter == actor)
                Fighter.CastAutoSpell(new Spell(12388, 1), Fighter.Cell);
