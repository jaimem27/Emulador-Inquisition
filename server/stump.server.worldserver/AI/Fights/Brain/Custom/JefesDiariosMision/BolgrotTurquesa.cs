...
{
    [BrainIdentifier((int)MonsterIdEnum.NORIE)]
    public class Norie : Brain
    {
        public Norie(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(5747, 1), Fighter.Cell);
        }
    ...
    [BrainIdentifier((int)MonsterIdEnum.CYANOG)]
    public class Cyanog : Brain
    {
        public Cyanog(AIFighter fighter)
           : base(fighter)
        {
            fighter.Fight.FightStarted += Fight_FightStarted;
        }
        ...
        private void Fight_FightStarted(IFight obj)
        {
            Fighter.CastAutoSpell(new Spell(5740, 1), Fighter.Cell);
        }
    ...
    [BrainIdentifier((int)MonsterIdEnum.KELPE)]
    public class Kelpe : Brain
    {
        public Kelpe(AIFighter fighter)
           : base(fighter)
        {
            fighter.Fight.FightStarted += Fight_FightStarted;
        }
        ...
        private void Fight_FightStarted(IFight obj)
        {
            Fighter.CastAutoSpell(new Spell(6184, 1), Fighter.Cell);
        }
