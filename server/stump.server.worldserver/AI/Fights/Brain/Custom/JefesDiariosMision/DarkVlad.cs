...
{
    [BrainIdentifier((int)MonsterIdEnum.DARK_VLAD)]
    public class Darkvlad : Brain
    {
        public Darkvlad(AIFighter fighter)
           : base(fighter)
        {
        ...
        {
            Fighter.CastAutoSpell(new Spell(4311, 1), Fighter.Cell);
        }
