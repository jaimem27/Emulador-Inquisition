...
namespace Stump.Server.WorldServer.Database.Npcs.Replies
{
    ...
    public class AddKamas : NpcReply
    {
        ...
        public override bool Execute(Npc npc, Character character)
        {
            ...
            {
                character.SendServerMessage("¡Ya tienes suficientes kamas!", System.Drawing.Color.DarkOrange);
                flag = false;
            }
            else
            {
                character.Inventory.AddKamas((ulong)Amount);
                character.SendServerMessage("Has recuperado " + Amount + " kamas.", System.Drawing.Color.DarkOrange);
                flag = true;
            }
            return flag;
        }
