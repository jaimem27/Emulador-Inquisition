...
{
    [Discriminator("SacerdoteReply", typeof(NpcReply), new System.Type[]
 {
  typeof(NpcReplyRecord)
 })]
    class SacerdoteReply : NpcReply
    {
        public SacerdoteReply(NpcReplyRecord record)
            : base(record)
        {
        }
        ...
        public override bool Execute(Npc npc, Character character)
        {
            ...
            var grade = Singleton<MonsterManager>.Instance.GetMonsterGrade(4175, 5);
            ...
            var grade1 = Singleton<MonsterManager>.Instance.GetMonsterGrade(4133, 5);
            var monster1 = new Monster(grade1, new MonsterGroup(0, position));

            var grade2 = Singleton<MonsterManager>.Instance.GetMonsterGrade(4135, 5);
