...
{
    [Discriminator("Sacerdote2Reply", typeof(NpcReply), new System.Type[]
 {
  typeof(NpcReplyRecord)
 })]
    class Sacerdote2Reply : NpcReply
    {
        public Sacerdote2Reply(NpcReplyRecord record)
            : base(record)
        {
        }
        ...
        public override bool Execute(Npc npc, Character character)
        {
            ...
            var grade = Singleton<MonsterManager>.Instance.GetMonsterGrade(4200, 5);
            ...
            var grade1 = Singleton<MonsterManager>.Instance.GetMonsterGrade(4136, 5);
            var monster1 = new Monster(grade1, new MonsterGroup(0, position));

            var grade2 = Singleton<MonsterManager>.Instance.GetMonsterGrade(4136, 5);
