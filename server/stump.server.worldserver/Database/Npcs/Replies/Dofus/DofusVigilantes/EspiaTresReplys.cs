...
{
    [Discriminator("EspiaTresReply", typeof(NpcReply), new System.Type[]
 {
  typeof(NpcReplyRecord)
 })]
    class EspiaTresReply : NpcReply
    {
        public EspiaTresReply(NpcReplyRecord record)
            : base(record)
        {
        }
        ...
        public override bool Execute(Npc npc, Character character)
        {
            ...
            var grade = Singleton<MonsterManager>.Instance.GetMonsterGrade(3978, 5);
            ...
            var grade1 = Singleton<MonsterManager>.Instance.GetMonsterGrade(3977, 5);
