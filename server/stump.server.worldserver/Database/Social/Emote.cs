        ...
        public ActorLook UpdateEmoteLook(Character character, ActorLook look, bool apply)
        {
            if (!apply)
            {
                ...
                if (EmoteId == EmotesEnum.EMOTE_GUILD)
                {
                    ...
                    try {
                        ...
                        if (character.Guild.Alliance.Id < 1) {
                            ...
                            playerLook.RemoveSkin ((short) character.Guild.Alliance.Emblem.Template.SkinId);
                ...
                if (EmoteId == EmotesEnum.EMOTE_ALLIANCE) {
                    try {
                        if (character.Guild.Alliance.Id < 1)
                            return look;
            ...
            switch (EmoteId)
            {
                ...
                case EmotesEnum.EMOTE_GUILD:
                {
                    ...
                    break;
                case EmotesEnum.EMOTE_ALLIANCE:
                {
                    try {
                        if (character.Guild?.Alliance?.Id == null || character.Guild?.Alliance?.Id < 1)
                            break;
                        ...
                        //short[] teste = { ally, (short)character.Guild.Emblem.Template.SkinId };
                        playerLook.AddSkin ((short) (character.Guild.Alliance.Emblem.SymbolShape + 2569));
                        playerLook.AddSkin ((short) character.Guild.Emblem.Template.SkinId);

                        //System.Console.WriteLine((short)character.Guild.Alliance.Emblem.Template.SkinId);
