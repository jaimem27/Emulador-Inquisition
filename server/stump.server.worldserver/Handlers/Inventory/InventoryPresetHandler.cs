...
namespace Stump.Server.WorldServer.Handlers.Inventory
{
    public partial class InventoryHandler : WorldHandlerContainer
    {
        ...
        [WorldHandler(CharacterPresetSaveRequestMessage.Id)]
        public static void HandleCharacterPresetSaveRequestMessage(WorldClient client, CharacterPresetSaveRequestMessage message)
        {

           SendCharacterPresetSaveRequestMessage(client, new Preset());
        }

        public static void SendCharacterPresetSaveRequestMessage(WorldClient client, Preset preset)
        {
