...
namespace Stump.Server.WorldServer.Handlers.Friends
{
    public class FriendHandler : WorldHandlerContainer
    {
        ...
        public static void HandleFriendsGetListMessage(WorldClient client, FriendsGetListMessage message)
        {
            ...
            SendAllianceVersatileInfoListMessage (client);
        }
        ...
        public static void HandleFriendJoinRequestMessage(WorldClient client, FriendJoinRequestMessage message)
        {
            ...
            if (character.Map.SuperArea.Id == 3)
            {
        ...
        {
            var alliances =
                AllianceManager.Instance.GetAlliancesFactSheetInformations().ToArray();
            client.Send (new AllianceListMessage(alliances));
        }

        public static void SendAllianceVersatileInfoListMessage (IPacketReceiver client) {
            client.Send (new AllianceVersatileInfoListMessage (AllianceManager.Instance.GetAlliancesVersatileInformations ().ToArray()));
        }
    }
}