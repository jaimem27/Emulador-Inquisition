...
namespace Stump.Server.WorldServer.Handlers.Approach
{
    public class ApproachHandler : WorldHandlerContainer
    {
        ...
        {
            client.Send(new AccountCapabilitiesMessage((uint)client.Account.Id, true, BreedManager.Instance.AvailableBreedsFlags,
                            BreedManager.Instance.AvailableBreedsFlags, (sbyte)client.UserGroup.Role, true, 0));
