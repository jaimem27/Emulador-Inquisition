...
namespace Stump.Server.WorldServer.Commands.Commands
{
    public class PassCommand : InGameCommand
    {
        ...
        {
            Aliases = new[] { "pass" };
            Description = "Permite pasar de turno automáticamente.";
        ...
        public override void Execute(GameTrigger trigger)
        {
            if (!trigger.Character.ForcePassTurn)
            {
                ...
                trigger.Character.SendServerMessage("Ahora saltaras todos los turnos automaticamente.");
            ...
            else
            {
                ...
                trigger.Character.SendServerMessage("Ya puedes jugar normal.");
