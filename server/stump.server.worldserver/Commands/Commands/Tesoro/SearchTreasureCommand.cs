...
namespace Stump.Server.WorldServer.Commands.Commands.CommandPlayer
{
    public class SearchTreasureCommand : SubCommandContainer
    {
        ...
        public override void Execute(TriggerBase trigger)
        {
            ...
            {
                gameTrigger.Character.SendServerMessage("No puedes encontrar nada aquí. Seguir mirando.");
            ...
            {
                gameTrigger.Character.SendServerMessage("Debes iniciar una búsqueda del tesoro para usar este comando.");
            }
        }
    }
}