...
namespace Game.Vote
{
    public class MonsterStarLoop : Singleton<MonsterStarLoop>
    {
        ...
        private static int _queueRefresherElapsedTime = 43200000;//2H 7200000
        ...
        private void StartLoop()
        {
            try
            {
                ...
                World.Instance.SendAnnounce("<b>Servidor :</b> Estrellas al máximo ! <b>Inquisition</b>.", System.Drawing.Color.AliceBlue);
