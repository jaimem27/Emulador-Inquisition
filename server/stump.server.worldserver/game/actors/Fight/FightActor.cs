       ...
       && buff.Spell.CurrentSpellLevel.MaxStack <= m_buffList.Count(entry => entry.Spell.Id == buff.Spell.Id
        ...
        public bool IsIndirectSpellCast(Spell spell)
        {
            ...
            return spell.Template.Id == (int) SpellIdEnum.TRICKY_EXPLOSION
                   ...
                   || spell.Template.Id == (int)SpellIdEnum.EARTH_WALL
        ...
        public bool IsInvisibleSpellCast(Spell spell)
        {
            ...
            return spellLevel.Effects.Any(entry => entry.EffectId == EffectsEnum.Effect_Trap) || // traps
                   ...
                   spell.Template.Id == (int)SpellIdEnum.POISONED_TRAP_71 || // trampa envenenada
                   spell.Template.Id == (int)SpellIdEnum.PARALYSING_TRAP_69 || // trampa de inmovilizacion
                   spell.Template.Id == (int)SpellIdEnum.INSIDIOUS_TRAP_77 || // trampa insidosa
                   spell.Template.Id == (int)SpellIdEnum.REPELLING_TRAP_73 || // trampa repulsiva
                   spell.Template.Id == (int)SpellIdEnum.LETHAL_TRAP_80 || // trampa mortal
                   spell.Template.Id == (int)SpellIdEnum.TOXIC_INJECTION_9803 || // inyeccion toxica
                   spell.Template.Id == (int)SpellIdEnum.DRIFT_TRAP_9806 || // trampa de deriva
                   spell.Template.Id == (int)SpellIdEnum.EPIDEMIC_9807 || // epidemia
                   spell.Template.Id == (int)SpellIdEnum.REPELLING_TRAP_9808 || // trampa repelente
                   spell.Template.Id == (int)SpellIdEnum.PROXIMITY_TRAP_9810 || // trampa de proximidad
                   spell.Template.Id == (int)SpellIdEnum.CALAMITY_9814 || // trampa de calamidad
                   spell.Template.Id == (int)SpellIdEnum.MALEVOLENT_TRAP_9812 || // trampa funesta
                   spell.Template.Id == (int)SpellIdEnum.TRAPS_9846 || // efectos trampas
                   spell.Template.Id == (int)SpellIdEnum.TRAPS_9847 || // efectos trampas
                   spell.Template.Id == (int)SpellIdEnum.TRAPS_10178 || // efectos trampas
                   spell.Template.Id == (int)SpellIdEnum.TRAPS_10179 || // efectos trampas
                   spell.Template.Id == (int)SpellIdEnum.TRAPS_10180 || // efectos trampas
                   spell.Template.Id == (int)SpellIdEnum.TRAPS_10181 || // efectos trampas
        ...
        public bool IsInvisibleSpellDofusCast(Spell spell)
        {
            ...
            return spell.Template.Id == (int) SpellIdEnum.CLOUDY_DOFUS || //DOFUS NEBULOSO
                   ...
                   spell.Template.Id == 8395 || //P�RPURA
