    ...
    public class SummonedMonster : SummonedFighter, ICreature
    {
        ...
        void AdjustStats()
        {
            if (Summoner.Level <= 200)
            {
                ...
                {
                    m_stats.Fields[PlayerFields.HealBonus].Base = (int)(m_stats.Fields[PlayerFields.HealBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.HealBonus] / 2d)));
                    m_stats.Fields[PlayerFields.FireDamageBonus].Base = (int)(m_stats.Fields[PlayerFields.FireDamageBonus].Total + ( 1 + (Summoner.Stats.Fields[PlayerFields.FireDamageBonus] / 2d)));
                    m_stats.Intelligence.Base = (short)(Monster.Intelligence + (1 + ((Summoner.Stats.Intelligence.Total + Summoner.Stats.Fields[PlayerFields.DamageBonusPercent]) / 2d)));
                }

                // Inflável
                else if (Monster.MonsterId == (int)MonsterIdEnum.LA_GONFLABLE)
                {
                    m_stats.Fields[PlayerFields.HealBonus].Base = (int)(m_stats.Fields[PlayerFields.HealBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.HealBonus].Total / 2d)));
                    m_stats.Fields[PlayerFields.FireDamageBonus].Base = (int)(m_stats.Fields[PlayerFields.FireDamageBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.FireDamageBonus].Total / 2d)));
                    m_stats.Intelligence.Base = (short)(Monster.Intelligence + (1 + ((Summoner.Stats.Intelligence.Total + Summoner.Stats.Fields[PlayerFields.DamageBonusPercent].Total) / 2d)));
                ...
                {
                    m_stats.Fields[PlayerFields.HealBonus].Base = (int)(m_stats.Fields[PlayerFields.HealBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.HealBonus].Total / 2d)));
                    m_stats.Fields[PlayerFields.WaterDamageBonus].Base = (int)(m_stats.Fields[PlayerFields.WaterDamageBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.WaterDamageBonus].Total / 2d)));
                    m_stats.Chance.Base = (short)(Monster.Chance + (1 + ((Summoner.Stats.Chance.Total + Summoner.Stats.Fields[PlayerFields.DamageBonusPercent].Total) / 2d)));
                }
                else
                ...
                {
                    m_stats.Fields[PlayerFields.EarthDamageBonus].Base = (int)(m_stats.Fields[PlayerFields.EarthDamageBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.EarthDamageBonus].Total / 2d)));
                    m_stats.Strength.Base = (short)(Monster.Strength + (1 + ((Summoner.Stats.Strength.Total + Summoner.Stats.Fields[PlayerFields.DamageBonusPercent].Total) / 2d)));
                }
                else
                {
                    m_stats.Fields[PlayerFields.EarthDamageBonus].Base = (int)(m_stats.Fields[PlayerFields.EarthDamageBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.EarthDamageBonus].Total / 2d)));
                ...
                {
                    m_stats.Fields[PlayerFields.AirDamageBonus].Base = (int)(m_stats.Fields[PlayerFields.AirDamageBonus].Total + (1 + (Summoner.Stats.Fields[PlayerFields.AirDamageBonus].Total / 2d)));
                    m_stats.Agility.Base = (short)(Monster.Agility + (1 + ((Summoner.Stats.Agility.Total + Summoner.Stats.Fields[PlayerFields.DamageBonusPercent].Total) / 2d)));
                }
                ...
                m_stats.Wisdom.Base = (short)(Monster.Wisdom + (1 + (Summoner.Stats.Wisdom.Total / 2d)));
            }
            else
            {
                m_stats.Health.Base = (short)(Monster.LifePoints * (200 / 100d));
