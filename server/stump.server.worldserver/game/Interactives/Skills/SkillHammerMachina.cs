    ...
    public class SkillHammerMachina : CustomSkill
    {
        ...
        public override int StartExecute(Character character)
        {
            ...
            if(miniGame != null)
            {
                ...
                {
                    character.OpenPopup("The Showdown está disponible una vez al día. <br> ¡Prueba suerte de nuevo mañana!");
                    return -1;
                }
            }            
            ...
            {
                character.OpenPopup("Necesitas equiparte con un martillo para jugar a este juego.");
                return -1;
            }
