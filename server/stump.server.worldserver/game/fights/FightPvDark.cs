            ...
            if (Winners.Fighters.Contains(BreedFighter))
            {
                ...
                if (dopple != null)
                {
                                        ...
                                        !Leavers.Contains(fightPlayerResult.Fighter)))
                    {
                        ...
                        var itemUnoEsmeralda = fightPlayerResult.Character.Inventory.TryGetItem(itemInicioQuest);
                        if (itemUnoEsmeralda != null)
                        {
                            fightPlayerResult.Loot.AddItem(new DroppedItem(15597, 1));
                            fightPlayerResult.Character.SendServerMessage("Has conseguido la espada de Dark Vlad.");
                        }
                    }
                }
            }
