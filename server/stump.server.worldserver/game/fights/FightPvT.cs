    ...
    public class FightPvT : Fight<FightTaxCollectorDefenderTeam, FightTaxCollectorAttackersTeam>
    {
        ...
        public override void StartPlacement()
        {
            ...
            if (TaxCollector.TaxCollectorNpc.Guild.Alliance != null)
            {
                ...
                foreach (var a in TaxCollector.TaxCollectorNpc.Guild.Alliance.m_guilds)  TaxCollectorHandler.SendTaxCollectorListMessage (TaxCollector.TaxCollectorNpc.Guild.Alliance.Clients, a.Value);

            } else //warn just guild
            {
