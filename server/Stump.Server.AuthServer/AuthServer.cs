    ...
    public class AuthServer : ServerBase<AuthServer>
    {
        ...
        public override void Initialize()
        {
            ...
            try
            {
                ...
                ConsoleBase.SetTitle($"#Inquisition Authentification Server - {Version}");
                ...
                // Esto es un mensaje falso que algún gracioso se le ocurrió poner, no patchea nada, simplemente escribe en la consola ésta mentira XD
        ...
        public override void Start()
        {
            ...
            if (Settings.EnableAntiDDoS == true)
                logger.Warn("BaseServer AntiDDoS - AuthServer side is running...");
